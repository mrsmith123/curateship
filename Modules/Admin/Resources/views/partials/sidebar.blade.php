<aside class="sidebar sidebar--static@md col-3@md js-sidebar text-right" {{-- Remove text-right for a left sidebar --}}
    data-static-class="sidebar--sticky-on-desktop z-index-1" id="sidebar" aria-labelledby="sidebarTitle">
    <div class="sidebar__panel">
        ...
        <div class="position-relative z-index-1">
            ...
            {{-- Left sidebar original class: bg border-right-sidebar padding-right-sm --}}
            <aside class="bg border-left padding-left-sm">
                <nav class="sidenav js-sidenav sidenav__flipped">
                    ...
                    <ul class="sidenav__list">
                        <li class="sidenav__item">
                            <a href="#0" class="sidenav__link">
                                ...
                                <span class="sidenav__counter">12 <i
                        ...
                        <li class="sidenav__item">
                            <a href="#0" class="sidenav__link">
                                ...
                                <span class="sidenav__counter">18 <i
                                        class="sr-only">notifications</i></span>
                            </a>
                        </li>
                        ...
                        <li class="sidenav__item">
                            <a href="#0" class="sidenav__link">
                                ...
                                <span class="sidenav__counter">122 <i
                                        class="sr-only">notifications</i></span>
                            </a>
                        </li>
